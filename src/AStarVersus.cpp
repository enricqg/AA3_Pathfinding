#include "AStarVersus.h"
#include <queue>
#include <map>
#include "SDL_SimpleApp.h"

AStarVersus::AStarVersus()
{
}

std::vector<Vector2D> AStarVersus::CalculatePath(Node* initialPos, Node* targetPos, Node* enemyPos)
{
...
Vector2D AStarVersus::cell2pix(Vector2D cell)
{
